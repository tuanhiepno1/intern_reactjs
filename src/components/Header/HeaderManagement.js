...
import { SettingOutlined, FileExcelOutlined, EditOutlined, DeleteOutlined, PlusOutlined, ClockCircleOutlined } from '@ant-design/icons';
import '../../assets/styles/Header.css';

const { Header } = Layout;

const CustomHeaderManage = ({ onAddNewProject }) => {
    return (
        <Header className="header-container">
            ...
            <Row className="header-search-row" justify="space-between" align="middle" style={{ marginTop: '20px' }}>
                ...
                <Col className="header-action-buttons" style={{ textAlign: 'right' }}>
                    <Button type="primary" icon={<ClockCircleOutlined />} className="header-btn-schedule">
                        Schedule Interview
                    </Button>
